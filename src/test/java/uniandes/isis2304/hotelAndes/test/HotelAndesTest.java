...
public class HotelAndesTest
{
	 ...
	 */
	private static Logger log = Logger.getLogger(HotelAndesTest.class.getName());
...
//			e.printStackTrace();
    ...
    private void crearTipos()
    {
    	...
    	hotelAndes.adicionarTipoHabitacion("SuiteDeLujo", "Linda suite");
    	hotelAndes.adicionarTipoHabitacion("Habitacion familiar", "para familia");
    	hotelAndes.adicionarTipoHabitacion("LunaDeMiel", "tematica romantica");
