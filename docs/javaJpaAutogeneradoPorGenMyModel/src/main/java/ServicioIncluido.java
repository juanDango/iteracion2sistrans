...
public class ServicioIncluido implements ServiciosHotelComplementarios
{
	/**
	 * <!-- begin-user-doc -->
	 * <!--  end-user-doc  -->
	...
	@javax.persistence.OneToOne 
	protected CaracteristicaServicio caracteristica;
	 ...
	 * @ordered
	 */
	public CaracteristicaServicio getCaracteristica() {
	 ...
	 * @ordered
	 */
	public void setCaracteristica(CaracteristicaServicio myCaracteristica) {
		this.caracteristica = myCaracteristica;
	}
	...
	public void unsetCaracteristica() {
		this.caracteristica = new CaracteristicaServicio();
	}
